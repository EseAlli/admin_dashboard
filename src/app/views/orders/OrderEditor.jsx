    ...
    return (
        <div className={clsx('invoice-viewer py-4', classes.invoiceEditor)}>
            <ValidatorForm onSubmit={handleSubmit} onError={(errors) => null}>
                <div className="viewer_actions px-4" style={{display: "flex", justifyContent:"flex-end"}}>
                    <div className="mb-6">
                        <Button
                            type="button"
                            className="mr-4 py-2"
                ...
                <div className={clsx("viewer__order-info px-4 mb-4 flex justify-between", classes.viewerAction)}>
                    <div>
                    ...
                    <Grid item>
                        <div>
                            ...
                            <TextValidator
                                ...
                                name="name"
                                fullWidth
                                value={customerId ? `${customerId.firstName} ${customerId.lastName}` : null}
                                validators={['required']}
                                errorMessages={['this field is required']}
                            />
                            <TextValidator
